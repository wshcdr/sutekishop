...
namespace Suteki.Shop
{
    ...
    partial void OnTimestampChanged();
		...
		[Association(Name="User_Order", Storage="_Orders", ThisKey="UserId", OtherKey="UserId")]
		...
		[Association(Name="User_Basket", Storage="_Baskets", ThisKey="UserId", OtherKey="UserId")]
    ...
    partial void OnDescriptionChanged();
		...
		[Association(Name="Image_ProductImage", Storage="_ProductImages", ThisKey="ImageId", OtherKey="ImageId")]
    ...
    partial void OnQuantityChanged();
		...
		[Association(Name="Size_BasketItem", Storage="_Size", ThisKey="SizeId", OtherKey="SizeId", IsForeignKey=true)]
		public Size Size
		{
			get
			{
		...
		[Association(Name="Basket_BasketItem", Storage="_Basket", ThisKey="BasketId", OtherKey="BasketId", IsForeignKey=true)]
    ...
    partial void OnRequiredIssueNumberChanged();
		...
		[Association(Name="CardType_Card", Storage="_Cards", ThisKey="CardTypeId", OtherKey="CardTypeId")]
    ...
    partial void OnTelephoneChanged();
		...
		[Association(Name="Contact_Order", Storage="_Orders", ThisKey="ContactId", OtherKey="CardContactId")]
		public EntitySet<Order> Orders
		{
			get
			{
		...
		[Association(Name="Contact_Order1", Storage="_Orders1", ThisKey="ContactId", OtherKey="DeliveryContactId")]
		...
		[Association(Name="Country_Contact", Storage="_Country", ThisKey="CountryId", OtherKey="CountryId", IsForeignKey=true)]
    ...
    partial void OnSecurityCodeChanged();
		...
		[Association(Name="Card_Order", Storage="_Orders", ThisKey="CardId", OtherKey="CardId")]
		public EntitySet<Order> Orders
		{
			get
			{
		...
		[Association(Name="CardType_Card", Storage="_CardType", ThisKey="CardTypeId", OtherKey="CardTypeId", IsForeignKey=true)]
    ...
    partial void OnPostZoneIdChanged();
		...
		[Association(Name="Country_Contact", Storage="_Contacts", ThisKey="CountryId", OtherKey="CountryId")]
		...
		[Association(Name="Country_Basket", Storage="_Baskets", ThisKey="CountryId", OtherKey="CountryId")]
		public EntitySet<Basket> Baskets
		{
			get
			{
		...
		[Association(Name="PostZone_Country", Storage="_PostZone", ThisKey="PostZoneId", OtherKey="PostZoneId", IsForeignKey=true)]
    ...
    partial void OnContactMeChanged();
		...
		[Association(Name="Card_Order", Storage="_Card", ThisKey="CardId", OtherKey="CardId", IsForeignKey=true)]
		public Card Card
		{
			get
			{
		...
		[Association(Name="Contact_Order", Storage="_Contact", ThisKey="CardContactId", OtherKey="ContactId", IsForeignKey=true)]
		...
		[Association(Name="Contact_Order1", Storage="_Contact1", ThisKey="DeliveryContactId", OtherKey="ContactId", IsForeignKey=true)]
		...
		[Association(Name="User_Order", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		[Association(Name="Basket_Order", Storage="_Basket", ThisKey="BasketId", OtherKey="BasketId", IsForeignKey=true)]
		public Basket Basket
		{
			get
			{
    ...
    partial void OnPositionChanged();
		...
		[Association(Name="Image_ProductImage", Storage="_Image", ThisKey="ImageId", OtherKey="ImageId", IsForeignKey=true)]
		public Image Image
		{
			get
			{
    ...
    partial void OnFlatRateChanged();
		...
		[Association(Name="PostZone_Country", Storage="_Countries", ThisKey="PostZoneId", OtherKey="PostZoneId")]
    ...
    partial void OnIsActiveChanged();
		...
		[Association(Name="Size_BasketItem", Storage="_BasketItems", ThisKey="SizeId", OtherKey="SizeId")]
		...
		[Association(Name="Product_Size", Storage="_Product", ThisKey="ProductId", OtherKey="ProductId", IsForeignKey=true)]
		public Product Product
		{
			get
			{
    ...
    partial void OnNameChanged();
		...
		[Association(Name="ContentType_Content", Storage="_Contents", ThisKey="ContentTypeId", OtherKey="ContentTypeId")]
    ...
    partial void OnIsActiveChanged();
		...
		[Association(Name="Content_Content", Storage="_Contents", ThisKey="ContentId", OtherKey="ParentContentId")]
		public EntitySet<Content> Contents
		{
			get
			{
		...
		[Association(Name="Content_Content", Storage="_Content1", ThisKey="ParentContentId", OtherKey="ContentId", IsForeignKey=true)]
		...
		[Association(Name="ContentType_Content", Storage="_ContentType", ThisKey="ContentTypeId", OtherKey="ContentTypeId", IsForeignKey=true)]
    ...
    partial void OnUrlNameChanged();
		...
		[Association(Name="Product_Size", Storage="_Sizes", ThisKey="ProductId", OtherKey="ProductId")]
		...
		[Association(Name="Product_Review", Storage="_Reviews", ThisKey="ProductId", OtherKey="ProductId")]
    ...
    partial void OnCountryIdChanged();
		...
		[Association(Name="Basket_BasketItem", Storage="_BasketItems", ThisKey="BasketId", OtherKey="BasketId")]
		public EntitySet<BasketItem> BasketItems
		{
			get
			{
		...
		[Association(Name="Basket_Order", Storage="_Orders", ThisKey="BasketId", OtherKey="BasketId")]
		public EntitySet<Order> Orders
		{
			get
			{
		...
		[Association(Name="Country_Basket", Storage="_Country", ThisKey="CountryId", OtherKey="CountryId", IsForeignKey=true)]
		public Country Country
		{
			get
			{
		...
		[Association(Name="User_Basket", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnCategoryIdChanged();
		...
		[Association(Name="Product_ProductCategory", Storage="_Product", ThisKey="ProductId", OtherKey="ProductId", IsForeignKey=true, DeleteOnNull=true)]
		public Product Product
		{
			get
			{
    ...
    partial void OnRatingChanged();
		...
		[Association(Name="Product_Review", Storage="_Product", ThisKey="ProductId", OtherKey="ProductId", IsForeignKey=true)]
		public Product Product
		{
			get
			{
